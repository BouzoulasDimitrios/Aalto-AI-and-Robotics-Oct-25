...
def main(port, robot_id, rate_hz):
    ...
    neutral = {"shoulder_pan": 0,  "shoulder_lift": -20, "elbow_flex": 40, "wrist_flex": -20, "wrist_roll": 0,  "gripper": 60}
    reach   = {"shoulder_pan": 15, "shoulder_lift": -35, "elbow_flex": 60, "wrist_flex": -25, "wrist_roll": 0,  "gripper": 60}
    grasp   = {"gripper": 20}
    open_   = {"gripper": 70}
